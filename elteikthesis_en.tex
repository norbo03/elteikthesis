...
% Document's metadata
\title{Static Analysis and Multithreading} % title
\date{2024} % year of defense

% Author's metadata
\author{Patrik Süli and Norbert-Botond Nagy}
\degree{Computer Science MSc}

% Superivsor(s)' metadata
\supervisor{Dr. habil. Zolt\'an Porkol\'ab} % internal supervisor's name
\affiliation{Associate Professor} % internal supervisor's affiliation
\extsupervisor{Knoll Judit} % external supervisor's name
\extaffiliation{Software Developer} % external supervisor's affiliation
